...
def curve_fit_network_out(filename, start_index, end_index):
    fp = open(filename)
    x=[]
    y=[]
    colors=[]
...
#curve_fit_network_in("data/robot_ball.csv", 38, 53)
curve_fit_cpu("data/robot_ball.csv", 38, 53)
#curve_fit_network_out("data/robot_ball.csv", 38, 53)
#curve_fit_network_in("data/unity_dots2.csv", 162, 167)
#curve_fit_cpu("data/unity_dots2.csv", 162, 167)

#curve_fit_network_out("data/unity_dots2.csv", 162, 167)